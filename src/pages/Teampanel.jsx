    ...
    <div className="flex h-screen bg-gradient-to-br from-[#0a0f2c] via-[#13233f] to-[#0a0f2c] text-white">
      ...
      <div className="w-72 bg-black/80 p-8 border-r-2 border-yellow-500/30 flex flex-col justify-between shadow-2xl rounded-r-3xl">
        <div>
          <div className="flex flex-col items-center mb-6">
            <img
              src="./KARE(latest).png"
              className="w-20 h-20 rounded-full border-4 border-yellow-400 shadow-lg mb-2"
              alt="KARE Logo"
            />
            <img
              src="./title.png"
          ...
          <h1 className="text-3xl text-yellow-400 mb-8 text-center drop-shadow-lg tracking-wide">
            Crew Dashboard
          </h1>
          <nav className="space-y-6">
            <a
              href="#team"
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-black/40 hover:bg-yellow-400 hover:text-black transition-all"
            >
              <img src="./team.png" className="w-8 h-6" alt="Team" />{" "}
            ...
            <a
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-black/40 hover:bg-yellow-400 hover:text-black transition-all"
            >
              <img src="./attd.png" className="w-6 h-6" alt="Attendance" />{" "}
        ...
        <button
          ...
          className="bg-gradient-to-r from-red-600 to-yellow-400 text-black font-bold px-6 py-3 rounded-xl shadow-lg hover:scale-105 transition-all mt-8"
        >
          Logout
        </button>
      </div>
      ...
      <div className="flex-1 bg-[url('./assets/latest.png')] bg-[#fff6d1]/80 overflow-y-auto p-6 space-y-8">
        ...
        <motion.div
          ...
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="bg-[url('./assets/Module-body-bg-transparent.png')] bg-[#e3ba82] bg-blend-overlay rounded-2xl p-6 border border-yellow-500/20 font-[poppins]"
        >
          <h2 className="text-xl text-[#34211A] font-semibold mb-4">
            <img src={member} className="w-16 inline" alt="Team" /> Team Members
          </h2>
        ...
        >
          <h2 className="text-xl text-[#34211A] font-semibold mb-4">
            <img src={atte} className="w-16 inline" alt="Attendance" />{" "}
            Attendance
          </h2>
          <AttendanceTable
            team={team}
        ...
        >
          <h2 className="text-xl text-[#34211A] font-semibold mb-4">
            <img src={prob} className="w-16 inline" alt="Attendance" /> Problem
            Statement
          </h2>
          <p className="text-[#34211A]">
            {team.problem || "No problem statement assigned yet."}
          </p>
        </motion.div>
        ...
        <motion.div
          id="leaderboard"
          className="bg-[url('./assets/Module-body-bg-transparent.png')] bg-[#e3ba82] bg-blend-overlay text-[#34211A] rounded-2xl p-6 border border-yellow-500/20 font-[poppins]"
        >
          <h2 className="text-xl font-bold mb-6">
            <img src={lead} className="w-16 inline" alt="Attendance" />{" "}
            Leaderboard
          </h2>
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center bg-gradient-to-br from-[#0a0f2c] via-[#13233f] to-[#0a0f2c]">
      <div className="bg-[#1b2a49]/80 rounded-2xl p-8 shadow-lg">
        ...
        <button
          onClick={check}
          className="w-full bg-yellow-400 text-black font-bold py-2 rounded-lg"
        >
          Enter
        </button>
      </div>
